...
from aurora_platform.schemas.etp_schemas import ETPRequest, ETPResponse, ETPStatus
...
async def get_etp_status(etp_id: str, current_user=Depends(get_current_user)):
    """Consulta o status de um ETP específico"""
    return ETPStatus(id=etp_id, status="concluido", progresso=100)
