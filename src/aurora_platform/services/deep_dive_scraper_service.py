...
class DeepDiveScraperService:
            ...
            if driver:
                ...
                try:
                    ...
                    if "Identificador inválido" in str(e):
                        logger.debug(
                            "Ignorando erro de 'Identificador inválido' no encerramento do driver, pois o processo já foi finalizado."
                        )
                    else:
    ...
    async def extract_text_from_url(self, url: str) -> str:
        ...
        try:
            ...
            logger.exception(
                f"Falha final ao extrair conteúdo de {url} após múltiplas tentativas. Erro: {e}"
            )
            return ""
