...
class OpenAIService:
    ...
    async def _call_llm_with_retry(self, user_question: str, system_prompt: str) -> AsyncGenerator[str, None]:
    ...
    async def generate_answer_stream(self, user_question: str, context: str) -> AsyncGenerator[str, None]:
        ...
        try:
            async for chunk in self._call_llm_with_retry(user_question=user_question, system_prompt=system_prompt):
                yield chunk
