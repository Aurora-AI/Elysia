...
from .llm_adapters import ILLMAdapter, VertexAIAdapter, AzureOpenAIAdapter, DeepSeekAdapter
...
class AdapterFactory:
    ...
    def create_adapter(provider_name: str) -> ILLMAdapter:
        ...
        if provider_name == "google":
            ...
            raise ValueError(f"Provedor de LLM desconhecido: '{provider_name}'. Os provedores suportados são: google, azure, deepseek.")