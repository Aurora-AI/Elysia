        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if not text_content:
                    ...
                    return {"url": url, "summary": "Não foi possível extrair conteúdo textual da página.", "raw_text_snippet": ""}
                ...
                return {
                    "url": url,
                    "summary": summary,
                    "raw_text_snippet": text_content[:500] + "..." # Retorna um trecho para verificação
                }
            except Exception as e:
                logger.exception(f"Erro durante o processo de fetch_and_summarize para {url}: {e}")
                raise
            finally:
                await browser.close()
