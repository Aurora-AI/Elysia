...
from .endpoints import auth_router, two_factor_router, knowledge_router, profiling_router
...
api_v1_router.include_router(profiling_router.router, prefix="/v1/profiling", tags=["Agent Profiling"])
