...
def is_password_compromised(password: str) -> bool:
    ...
    breached_passwords = {
        ...
        'admin', 'letmein', 'welcome', '12345678', '1234567890', 'qwertyuiop',
        'asdfghjkl', 'zxcvbnm', 'password1', 'password12', 'iloveyou',
        'princess', 'rockyou', 'monkey', 'dragon', 'sunshine', 'master',
        'trustno1', 'football', 'baseball', 'superman', 'hello', 'freedom'
    }
